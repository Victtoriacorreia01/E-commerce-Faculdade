...
const Cart = () => {
    ...
    const loadCart = async () => {
      try {
        ...
        if (!cartData || !Array.isArray(cartData.items)) {
          console.warn("Cart data is invalid. Falling back to local cart.");
  ...
  const handleIncreaseQuantity = async (id) => {
    try {
      ...
      calculateTotal(updatedCartData.items || []);
    } catch (error) {
        ...
        <>
          ...
          <div className={styles.orderSummary}>
            ...
            <div className={styles.buttonContainer}>
              <button className={styles.emptyCartButton} onClick={handleClearCart}>
                Empty Cart
              </button>
